...
Version 1 is read-only. Report any path-containment, symlink/junction, prompt-injection, or unintended-write issue as a security bug.

## Reporting

Open a GitHub issue for non-sensitive bugs. For sensitive reports, contact the maintainer without including private notes, paths, or secret values in the issue.
