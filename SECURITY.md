...
Do not publish real Obsidian vaults, personal notes, `local-config.json`, account exports, tokens, cookies, API keys, or other credentials.
...
Version 1 does not modify vault content. Report any path-containment, symlink/junction, prompt-injection, or unintended-write issue as a security bug.
